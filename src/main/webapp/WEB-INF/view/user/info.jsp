	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" method="post">
			   <div class="form-group">
					...
					<button id="btnAdd" type="button" onclick="$('#userInfoForm').submit();" class="btn btn-success btn-sm" style="margin-left: 13px;" style="display: none;">
					  	<i class="fa fa-user-plus"></i>&nbsp;保存
					</button>
					<button id="btnBack" type="button" onclick="top.location.href = 'index.html'" class="btn btn-info btn-sm">
